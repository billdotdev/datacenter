...
assert_contains platform/data/postgres/cluster.yaml 'cpu: 100m'
assert_contains platform/data/postgres/cluster.yaml 'memory: 256Mi'
assert_contains platform/data/postgres/cluster.yaml 'memory: 512Mi'
