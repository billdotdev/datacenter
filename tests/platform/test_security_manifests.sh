...
assert_contains platform/security/cert-manager/values.yaml 'cainjector:'
assert_contains platform/security/cert-manager/values.yaml 'resources:'
assert_contains platform/security/cert-manager/values.yaml 'memory: 32Mi'
assert_contains platform/security/cert-manager/values.yaml 'memory: 64Mi'
assert_contains platform/security/cert-manager/values.yaml 'memory: 128Mi'
