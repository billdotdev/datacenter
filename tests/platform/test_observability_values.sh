...
assert_contains platform/observability/loki/values.yaml 'allocatedMemory: 1024'
assert_contains platform/observability/loki/values.yaml 'resultsCache:'
assert_contains platform/observability/loki/values.yaml 'allocatedMemory: 512'
